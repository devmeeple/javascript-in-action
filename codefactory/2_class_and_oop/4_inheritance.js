...
const meeple = new IdolModel('미플', 1592);
console.log(meeple);
...
console.log('-------------');
console.log(meeple instanceof IdolModel);
console.log(meeple instanceof FemaleIdolModel);
console.log(meeple instanceof MaleIdolModel);